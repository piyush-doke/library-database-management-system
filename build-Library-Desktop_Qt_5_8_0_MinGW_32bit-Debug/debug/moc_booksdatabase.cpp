...
#include "../../Library/booksdatabase.h"
...
struct qt_meta_stringdata_booksDatabase_t {
    QByteArrayData data[3];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_booksDatabase_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_booksDatabase_t qt_meta_stringdata_booksDatabase = {
    {
QT_MOC_LITERAL(0, 0, 13), // "booksDatabase"
QT_MOC_LITERAL(1, 14, 24), // "on_click_addBook_clicked"
QT_MOC_LITERAL(2, 39, 0) // ""

    },
    "booksDatabase\0on_click_addBook_clicked\0"
    ""
};
...
const QMetaObject booksDatabase::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_booksDatabase.data,
      qt_meta_data_booksDatabase,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *booksDatabase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_booksDatabase.stringdata0))
